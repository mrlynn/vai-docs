      ...
      items: [
        ...
        },
        {
          ...
          items: [
            ...
            'commands/advanced/workflow-install',
            'commands/advanced/workflow-uninstall',
            'commands/advanced/workflow-search',
            'commands/advanced/workflow-create',
            'commands/advanced/workflow-info',
          ],
        },
      ],
    },
      ...
      items: [
        ...
        },
        {
          ...
          items: [
            ...
            'guides/workflows/publishing-workflows',
          ],
        },
        {
          type: 'category',
